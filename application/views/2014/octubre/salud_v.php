                <div class="container">
                    ...
                    <div class="frame">
                        <div class="bit-90 purple-text">
                            <?=br(1);?>
                            <p>Asimismo, la Universidad de Bristol sugiere que la presencia de bacterias en las encías está ligada al riesgo de sufrir un infarto.</p>
                        </div>
                        <div class="bit-10-1">
                    ...
                    <div class="frame">
                        ...
                        <span class="source">
                            <?=auto_link('Fuente: http://dentalroch.net/alimentos-buenos-y-malos-para-los-dientes');?>
                        </span>
                    </div>
                    <?=br(1);?>
                    <div class="frame">
