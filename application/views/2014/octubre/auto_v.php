                <div class="container">
                    ...
                    <div class="frame darkblue">
                        <div class="bit-3">
                            <?=img('images/assets/auto_icono_1.png');?>
                            <br />
                            <h4>&#149; Ponchadura y estallidos de llantas</h4>
                        </div>
                        <div class="bit-3">
                            <?=img('images/assets/auto_icono_2.png');?>
                            <br />
                            <h4>&#149; Fallas en la suspensi&oacute;n y direcci&oacute;n</h4>
                        </div>
                        <div class="bit-3">
                            <?=img('images/assets/auto_icono_3.png');?>
                            <br />
                    ...
                    <div class="frame">
                        <div class="bit-3" style="text-align:center;">
                            <p>Ocupar el m&iacute;nimo espacio posible del camino</p>
                            <br />
                            <?=img('images/assets/auto_icono_6.png');?>
                        </div>
                        <div class="bit-3" style="text-align:center;">
                            <p>Encender las luces intermitentes</p>
                            <br />
                            <br />
                            <?=img('images/assets/auto_icono_5.png');?>
                        </div>
                        <div class="bit-3" style="text-align:center;">
                            <p>Colocar cuidadosamente los tri&aacute;ngulos de emergencia</p>
                            <br />
                    ...
                    <div class="frame">
                        <div class="bit-1" style="text-align:center;">
                            <h2>En AXA contamos con servicios de asistencia automovilística, médica y administrativa. Si necesitas apoyo ante estas situaciones, llámanos al:</h2>
                            <br />
