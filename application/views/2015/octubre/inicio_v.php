                        ...
                        <div class="frame">
                            <div class="bit-70 rounded shadow blue-square clearfix" id="two-row-span">
                                ...
                                <div class="bit-60 clearfix">
                                    ...
                                    <p class="bit-50"><?=anchor( '2015/octubre/hogar', img( 'images/assets/2015/julio/home/leer-mas.png', 'Leer más' ) );?></p>
                                </div>
                            </div>
                            <div class="bit-30 clearfix share-form">
                                <div class="share bit-1 centered blue-square rounded shadow clearfix">
                                    <h4 class="bit-60 clearfix">Compartir:</h4>
                            ...
                            <div class="bit-3 navy-border">
                                <div class="square dark-text shadow gray-border ">
                                    <div class="bit-1 dark-text inner-square first">
                                        ...
                                        <p class="bit-40"><?=anchor( '2015/octubre/salud', img( 'images/assets/2015/julio/home/leer-mas.png', 'Leer más' ) );?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="bit-3 navy-border">
                                <div class="square dark-text shadow gray-border">
                                    <div class="bit-1 dark-text inner-square second">
                                        ...
                                        <p class="bit-40"><?=anchor( '2015/octubre/futuro', img( 'images/assets/2015/julio/home/leer-mas.png', 'Leer más' ) );?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="bit-3">
                                <div class="square dark-text shadow gray-border">
                                    <div class="bit-1 inner-square third">
                                        ...
                                        <p class="bit-40"><?=anchor( '2015/octubre/auto', img( 'images/assets/2015/julio/home/leer-mas.png', 'Leer más' ) );?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bit-3">
                                <div class="small-square">
                                    <div class="bit-1 inner-square first" style="background-color:#e8e7e5;">
                                        ...
                                        <h4 class="bit-60 centered">Fácil y en todo momento.</h4>
                            ...
                            <div class="bit-3">
                                <div class="small-square">
                                    <div class="bit-1 inner-square second" style="background-color:#dcd9d6;">
                                        ...
                                        <p class="bit-60 centered">
                                            <?=anchor( 'http://portal.axa.mx/Personas/ServicioAXA/Contactanos/Paginas/Quejas.aspx', img('images/assets/btn_hazclicaqui.png'), [ 'anchor'=>'_blank', 'class' =>'clearfix' ] );?>
                            ...
                            <div class="bit-3">
                                <div class="small-square" style="background-color:#e8e7e5;">
                                    <div class="bit-1 inner-square third">
                                        ...
                                        <p class="bit-60 centered">
                                            <?=anchor( 'https://youtu.be/NVWhGQIb04g', img( 'images/assets/2015/julio/home/conoce-mas-aqui.png' ), [ 'target' => '_blank' ] );?>
