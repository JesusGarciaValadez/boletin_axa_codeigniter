...
<div class="container future">
    <div class="frame clearfix bit-1 title">
        ...
        <div class="bit-40">
            <?=img( 'images/assets/2015/mayo/futuro/alcancia.png' );?>
        </div>
        <div class="bit-1">
            <?=img( 'images/assets/2015/mayo/futuro/dibujos-relacionados-con-dinero.png' );?>
        </div>
    </div>
    ...
    <div class="bit-1 clearfix frame section-2">
        <div class="bit-1 clearfix sub-section-1">
            <div class="bit-2">
                <?=img( 'images/assets/2015/mayo/futuro/uno.png' );?>
            ...
            <div class="bit-2">
                <?=img( 'images/assets/2015/mayo/futuro/dos.png' );?>
        ...
        <div class="bit-1 clearfix sub-section-2">
            <div class="bit-2">
                <?=img( 'images/assets/2015/mayo/futuro/tres.png' );?>
            ...
            <div class="bit-2">
                <?=img( 'images/assets/2015/mayo/futuro/cuatro.png' );?>
        ...
        <div class="bit-1 clearfix sub-section-3">
            <div class="bit-2">
                <?=img( 'images/assets/2015/mayo/futuro/cinco.png' );?>
            ...
            <div class="bit-2">
                <?=img( 'images/assets/2015/mayo/futuro/seis.png' );?>
    ...
    <div class="bit-1 clearfix frame section-4">
        <div class="bit-3 clearfix"><?=img( 'images/assets/2015/mayo/futuro/nota.png' );?></div>
        <div class="bit-666">
    ...
    <div class="frame related bit-1">
        <div class="bit-3 clearfix">
            ...
            <ul class="bit-1">
                <li class="bit-1"><?=anchor( 'https://www.boletinaxa.com.mx/anterior/tu-salud-junio-2014.html','Tú puedes ser tu propio jefe.' );?></li>
                <li class="bit-1"><?=anchor( 'https://www.boletinaxa.com.mx/anterior/tu-salud-marzo-2014.html','México carece de una cultura del ahorro.' );?></li>
            </ul>
        </div>
    </div>
    <div class="bit-3 clearfix qualify frame">
        <p class="bit-20">Califica</p>
        <ul class="bit-80 stars" data-section="futuro" data-month="abril" data-year="2015">
            <li>
