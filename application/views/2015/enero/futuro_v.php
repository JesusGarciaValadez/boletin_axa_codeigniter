                            <div class="container futuro">
                                ...
                                <div class="frame skyblue">
                                    <div class="bit-2" style="padding:0"><br>
                                        <?=img('images/assets/futuro_files/banner_principal.png');?> <br><br>
                                    </div><br>
                                    <div class="bit-2">
                                        <br>
                                        <h1>¿Cómo recuperarte <br>de los gastos de diciembre?</h1><br>
                                    ...
                                    <div class="frame graytext">
                                        <div class="bit-60"><br>
                                            <p style="text-align:left; font-size:1.1em;">La famosa cuesta de enero, llamada así por la escasa o nula
                                                ...
                                                recursos sean insuficientes para solventar los gastos de enero.</p>
                                            </div>
                                            <div class="bit-40">
                                        ...
                                        <div class="frame light-yellow">
                                            <div class="bit-20"><?=img('images/assets/futuro_files/grafica.png');?> </div>
                                            <div class="bit-80">
                                    ...
                                    <div class="frame graytext">
                                        <div class="bit-2">
                                            <div style="height:60px">
                                                <h2 style="text-align:center; color:#6CF">&#8226; Analiza tu capacidad de pago</h2>
                                            </div>
                                        ...
                                        <div class="frame graytext">
                                            ...
                                            <div style="min-height:110px">
                                                <p style="text-align:left; padding-left:10px">Utiliza mecanismos de ahorro que no te permitan retirar el dinero fácilmente o invierte a largo plazo. Aunque sea una cantidad pequeña, ese dinero te generará rendimientos. Una excelente opción son los seguros de vida ya que, además de ayudarte a ahorrar, te protegen a ti y a tu familia en caso de que llegaras a faltar.</p>
                                            </div><br>
