...
<div class="container">
 <?=($this->session->flashdata('msg') ? '<p style="color:red;font-size:.8em;">'.$this->session->flashdata('msg').'</p>' : '');?>
    ...
    <div class="bit-40" style="padding:0px;">
        <?=img('images/assets/salud_files/banner_principal.jpg');?>     </div>
</div>
...
<div class="frame purple-light">
    ...
    <div class="bit-1 purple-text">
      <div class="bit-3 tips">
        <p style="font-size:1.3em; text-align:left; padding-left:10px;">1. Lo más importante es<br>
 mantenerse en un peso ideal.</p>
          <?=img('images/assets/salud_files/peso.png');?> >   <br>
     </div>

        <div class="bit-3 tips">
            <p style="font-size:1.3em; text-align:left; padding-left:10px;">2. Ejercita tu cuerpo, por<br>
 lo menos camina 15 minutos<br>
 al día.</p>
            <?=img('images/assets/salud_files/correr.png');?>   <br>
      </div>

        <div class="bit-3 tips">
            <p style="font-size:1.3em; text-align:left; padding-left:10px;">3. Evita malas posturas y<br>
 permanecer sentado por<br>
 largos periodos.</p>
...
postura y relajar la tensión de la espalda.</p>
    </div>
...
Sólo 10 minutos de estos ejercicios marcarán la diferencia.</p>
    </div>
...
Además, es importante complementar esta dieta con multivitamínicos como el omega 3 y el complejo B, pues ayudan a
reducir el dolor de los nervios de la columna.</p>
    </div>
...
<div class="frame">
    <div class="bit-1 text"><br>
        <p>Cuando la lumbalgia no es tratada adecuadamente puede ocasionar recaídas frecuentes e impedir el regreso a las actividades cotidianas, provocando periodos prolongados de incapacidad. Por ello, en AXA contamos con programas de acompañamiento para este tipo de padecimientos.<br><br>
Si requieres de atención pregunta a tu agente sobre el programa +Care Ortopedia o llámanos al <strong>01 800 AXA CARE (292 2273)</strong> o escríbenos a <strong>axacare@axa.com.mx</strong></p>
    </div>
</div><br>
        ...
        <table class="related">
            ...
            <tr>
                <td>
                    ...
                    <span class="pink-text">•</span> <?=anchor('http://www.boletinaxa.com.mx/anterior/tu-salud-marzo-2014.html','Enfermedades crónico degenerativa');?>                </td>
            </tr>
            </tbody>
        </table>
    </div>
